...
class Simulator(object):
    def __init__(self, csv, train_split, dummy_period=None, ATR=False, SMA=False, RSI=True, BB=True, train=True):
...
class TradingEnv(gym.Env):
    ...
    def initialise_simulator(self, csv, ATR, SMA, RSI, BB, trade_period=1, train_split= 0.8, dummy_period=None):
        self.sim = Simulator(csv, ATR=ATR, SMA=SMA, train_split=train_split, dummy_period=dummy_period)
