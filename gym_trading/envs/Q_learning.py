    ...
    def run_episodes(self, episodes, train=True):
        ...
        for episode in range(episodes):
            ...
            if train:
                ...
                print("End of episode %s from %s to %s, Total reward is %s"%(episode+1, self.env.sim.date_time[start], self.env.sim.date_time[end], self.env.portfolio.total_reward) )
            else:
