    ...
    def run_episodes(self, episodes, train=True):
        ...
        for episode in range(episodes):
            ...
            if not train:
                ...
                print("End of Test Period from %s to %s, Average Reward is %s"%(self.env.sim.date_time[start], self.env.sim.date_time[end], self.env.portfolio.average_profit_per_trade))
            else:
